...
<CardGroup cols={2}>
  ...
  <Card title="Write a plugin" icon="puzzle-piece" href="/build-an-oracle/build/write-a-plugin">
    Recreate the Weather plugin from scratch.
  </Card>
  <Card title="createOracleApp options" icon="square-list" href="/build-an-oracle/build/create-oracle-app">
...
| All authenticated requests return 401 | UCAN signing mnemonic not loaded — see [Identity and auth](/build-an-oracle/build/identity-and-auth#signing-mnemonic). |
