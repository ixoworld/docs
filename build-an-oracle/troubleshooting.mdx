...
**Fix:** Mount a volume at `MATRIX_STORE_PATH` (and `SQLITE_DATABASE_PATH`). See [Deployment](/build-an-oracle/build/deploy).
...
<CardGroup cols={2}>
  ...
  <Card title="Deployment" icon="rocket-launch" href="/build-an-oracle/build/deploy">
