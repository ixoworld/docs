...
- [Create your oracle](/build-an-oracle/build/create-oracle-app) — hands-on walkthrough.
- [Using bundled plugins](/build-an-oracle/build/enable-bundled-plugins) — the `features` field in detail.
