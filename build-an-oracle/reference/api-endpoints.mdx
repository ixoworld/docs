...
- [Identity and auth](/build-an-oracle/build/identity-and-auth) — the UCAN flow.
- [Plugin HTTP endpoints](/build-an-oracle/build/plugin-recipes/add-http-endpoints) — adding your own routes.
