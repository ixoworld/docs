...
- **Tools:** none.
- **Sub-agents:** none.
- **Middlewares:** `createCreditsMiddleware` (aborts the agent run when the user is out of credits).
...
<CardGroup cols={2}>
  <Card title="Add a middleware" icon="layer-group" href="/build-an-oracle/build/plugin-recipes/add-a-middleware">
    The pattern `createCreditsMiddleware` uses.
  </Card>
  <Card title="Identity and auth" icon="id-card" href="/build-an-oracle/build/identity-and-auth">
