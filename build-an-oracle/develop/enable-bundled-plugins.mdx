...
description: "Toggle the 14 bundled plugins via the features map. Opt out, force on, or let auto-detect handle it."
icon: "boxes-stacked"
---
...
<Steps>
  <Step title="The runtime starts with the bundled list">
    [`BUNDLED_PLUGINS`](https://github.com/ixoworld/ixo-oracles-boilerplate/blob/main/packages/oracle-runtime/src/plugins/index.ts) is a fixed 14-plugin tuple — memory, portal, firecrawl, domain-indexer, composio, sandbox, skills, editor, agui, slack, tasks, credits, calls, user-preferences.
