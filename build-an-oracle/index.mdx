...
That's a working oracle. One call to [`createOracleApp`](/build-an-oracle/build/create-oracle-app) and the framework gives you:
...
<CardGroup cols={2}>
  <Card title="Build track" icon="hammer" href="/build-an-oracle/build/overview">
...
2. [`createOracleApp` options](/build-an-oracle/build/create-oracle-app) — every option you can pass.
3. [Write a plugin](/build-an-oracle/build/write-a-plugin) — the canonical end-to-end recipe.
