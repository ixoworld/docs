...
graph TB
    ...
    subgraph Runtime["@ixo/oracle-runtime"]
        ...
        Bundled["14 bundled plugins<br/>memory · skills · sandbox · editor · agui · portal · firecrawl · domain-indexer · composio · user-preferences · matrix-group-chats · tasks · vfs · oracle-payments"]
