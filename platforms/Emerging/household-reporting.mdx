---
title: 'Household Reporting'
icon: 'file-chart-column'
description: 'Track and report household-level monitoring data for clean cooking initiatives'
---
...
Household-level monitoring aggregates data from one or more cooking devices used by a family or dwelling. Rather than tracking each device in isolation, this approach ensures a holistic view of how the household's collective cooking practices influence fuel consumption and emissions. By using the Emerging Household Energy's decentralized identifiers (DIDs), verifiable credentials, and data orchestration tools, you can automate the measurement, reporting, and verification (MRV) of these activities while aligning with Mitigation Activity Design Documents, recognized standards and methodologies (Gold Standard for Metered & Measured Energy Cooking Devices).

## Target Population Description

The monitoring plan must include a comprehensive description of target households to account for project-specific circumstances. This description should capture:

### Household Characteristics
- Geographic location and environmental context
- Household structure and composition
- Income levels and economic factors
- Occupational patterns
- Seasonal variations in behavior

### Behavioral Factors
- Existing cooking practices and fuel usage patterns
- Social and cultural influences on cooking behavior
- Environmental factors affecting fuel choices
- Seasonal variations in cooking needs

### Monitoring Considerations
- Stratification requirements based on household diversity
- Sampling design incorporating behavioral factors
- Inclusion/exclusion criteria alignment
- Impact of geographical and seasonal variations

This demographic and behavioral data is stored as metadata in the household's digital twin, enabling:
- Informed sampling strategies
- More accurate baseline calculations
- Better understanding of adoption patterns
...
Household-level monitoring on the Emerging Household Energy provides a robust, verifiable, and scalable framework for clean cooking dMRV. By registering households and their devices under DIDs, collecting real-time sensor data, and employing Oracle-based validation—enhanced by causal AI—the system accurately attributes emission reductions, even under complex stove-stacking scenarios. This holistic approach not only bolsters credibility among stakeholders and carbon registries but also yields actionable insights for program improvement.
