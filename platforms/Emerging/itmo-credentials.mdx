---
title: 'ITMO Verifiable Credentials'
description: 'Implementation guide for using Verifiable Credentials (VCs) to issue and validate ITMO certificates'
---
...
<CardGroup>
  <Card title="ITMO Schema" icon="arrow-right" href="/models/itmo-schema">
    - Verifiable Credentials for ITMO certificates
  </Card>
  <Card title="ITMO Context" icon="arrow-right" href="/models/itmo-context">
    - Vocabulary for ITMO certificates
  </Card>
</CardGroup>
