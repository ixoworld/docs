...
description: 'Technical guide for implementing Sustainable Development Goal (SDG) monitoring using the Emerging Platform'
---

The Emerging Platform uses decentralized Measurement, Reporting, and Verification (dMRV) to track SDG indicators through:
