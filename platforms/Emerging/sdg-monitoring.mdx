---
title: 'Emerging Household Energy SDG monitoring'
icon: 'bullseye-arrow'
description: 'Implement SDG monitoring in the Emerging Household Energy solution using dMRV and verifiable claims.'
---
...
<Card title="Registry API" icon="chart-line" href="/api-reference/registry-api">
  API interface to get SDG reporting data
</Card>
<Card title="dMRV protocols" icon="ruler" href="/platforms/Emerging/dmrv">
