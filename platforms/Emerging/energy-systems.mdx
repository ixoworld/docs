---
title: 'Emerging Household Energy systems'
icon: 'bolt'
description: 'Model and monitor household energy systems in the Emerging Household Energy solution using digital twins and verification workflows.'
---
...
<CardGroup>
  <Card title="IoT Connectivity" icon="wifi" href="/guides/dev/spatial-web-sdks">
...
<CardGroup>
  ...
  <Card title="SDKs" icon="box" href="/guides/dev/spatial-web-sdks">
