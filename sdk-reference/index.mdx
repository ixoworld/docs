...
<AccordionGroup>
  ...
  <Accordion title="Personal Agent ADK" icon="robot">
    ...
    <CardGroup>
      <Card title="Documentation" href="/sdk-reference/oracle-adk" icon="book">
        Learn how to use the Personal Agent ADK
      </Card>
      <Card title="Private GitHub" href="https://github.com/ixoworld/ixo-ai-oracles" icon="github">
        Request repository access
      </Card>
    </CardGroup>
  </Accordion>
