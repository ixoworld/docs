...
<Tip>
  This guide walks through first-touch IXO **domain** and **digital twin** setup—how you get a real actor or asset onto the **shared map** of state. If you are building **agents and cooperative workflows**, read [What you can build](/guides/what-you-can-build), then [Qi: cooperation on verified workflows](/articles/qi-intelligent-cooperating-system) and [Agentic Oracles](/articles/agentic-oracles), and use the [Agentic Oracles ADK](/sdk-reference/agentic-oracles-adk) and [Personal Agent ADK](/sdk-reference/oracle-adk) when you wire code.
</Tip>

<Steps>
  <Step title="Set up your personal IXO domain">
    <AccordionGroup>
...
- An active IXO domain with a unique IID
