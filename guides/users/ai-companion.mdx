...
<AccordionGroup>
  <Accordion title="Ecosystem Navigation" icon="compass">
    ...
    **Companion**: "Digital twins are virtual representations of real-world entities in the IXO ecosystem. They can represent people, Organisations, projects, or assets.
...
<CardGroup>
  <Card title="User onboarding guide" icon="video" href="/guides/users/intro-users">
    Start with the core user onboarding path
  </Card>
  ...
  <Card title="Feature requests" icon="lightbulb" href="mailto:support@ixo.world?subject=AI%20Companion%20Feature%20Request">
    Suggest new capabilities through support
  </Card>
</CardGroup>
