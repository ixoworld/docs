...
<CardGroup>
  <Card title="IXO SDKs" icon="code" href="/sdk-reference/index">
...
<AccordionGroup>
  <Accordion title="IXO MultiClient SDK" icon="network-wired">
    ...
    [Learn more about the IXO MultiClient SDK](/sdk-reference/multiclient-sdk)
  </Accordion>
  
  <Accordion title="IXO Matrix Client SDK" icon="database">
    ```bash
    npm install @ixo/matrixclient-sdk
    ```

    The IXO Matrix Client SDK enables:
    - Secure data room creation
    - End-to-end encrypted messaging
    - File storage
    - Access control management
    
    [Learn more about the IXO Matrix Client SDK](/sdk-reference/matrix-client-sdk)
  </Accordion>
  
  <Accordion title="Agentic Oracles SDK" icon="brain">
    ```bash
    ...
    [Learn more about the Agentic Oracles SDK](/ixo-stack/sdks/oracle-agent-sdk)
  </Accordion>
</AccordionGroup>
<Info>
> If you are using the [IXO MultiClient SDK](/sdk-reference/multiclient-sdk), familiarize yourself with the [Signing Client](https://www.npmjs.com/package/@ixo/impactxclient-sdk#signing-client) to understand how to sign and broadcast transactions.
Familiarize yourself with the [IXO Blocksync GraphQL API](/api-reference/blocksync-graphql-api) queries for retrieving data from the blockchain.
</Info>
