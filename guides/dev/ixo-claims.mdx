...
<CardGroup>
  <Card title="API Reference" icon="book" href="/api-reference/claims">
    Claims module API documentation
  </Card>
  
  <Card title="SDK Guide" icon="code" href="/guides/dev/claims-sdk">
    Client SDK implementation guide
  </Card>
  
  <Card title="Examples" icon="lightbulb" href="/guides/dev/claims-examples">
    Implementation examples
  </Card>
