...
description: 'Create and manage NFT-backed identities on the IXO blockchain using the IXO MultiClient SDK'
---
...
Entity accounts enable delegated operations and Capability-based permissions for entity management.
...
<AccordionGroup>
  <Accordion title="CreateEntity" icon="plus">
    Creates a new entity.

    **Parameters:** `entityType?, context?, relayerNodeDid?, relayerNode?, signer?`
  </Accordion>

  <Accordion title="TransferEntity" icon="arrow-right-arrow-left">
    Transfers entity ownership.

    **Parameters:** `signer?, entities[], recipientDid?, memo?`
  </Accordion>

  <Accordion title="UpdateEntityVerified" icon="badge-check">
    Updates verification status.

    **Parameters:** `signer?, entityDids[], relayerDid?, entityVerified?`
  </Accordion>

  <Accordion title="CreateEntityAccount" icon="user-plus">
    Creates an entity account.

    **Parameters:** `entityDid, name?, signer?`
  </Accordion>

  <Accordion title="GrantEntityAccountAuthz" icon="key">
    Grants account authorization.

    **Parameters:** `entityDid, name?, grantee?, signer?, genericAuthMsg?`
  </Accordion>

  <Accordion title="MsgRevokeEntityAccountAuthz" icon="ban">
    Revokes authorization.

    **Parameters:** `entityDid, name?, grantee?, msgTypeUrl?, signer?`
  </Accordion>
</AccordionGroup>
