...
<AccordionGroup>
  <Accordion title="Decentralized Identity and Credentials" icon="fingerprint">
    Create and manage decentralized identifiers (DIDs) for entities, enabling sovereign control and cryptographic verification of identity credentials.
  </Accordion>
  
  <Accordion title="Verifiable Ownership and Control" icon="key">
    Establish and verify ownership rights through cryptographic proofs, with support for multiple controllers and DAO governance mechanisms.
  </Accordion>
