...
import { Steps, Card, Tabs } from '@mintlify/components';
...
| Authorization Type | Message Type | Description |
|-------------------|--------------|-------------|
| `SubmitClaimAuthorization` | `/ixo.claims.v1beta1.MsgSubmitClaim` | Authorization for submitting claims |
| `EvaluateClaimAuthorization` | `/ixo.claims.v1beta1.MsgEvaluateClaim` | Authorization for evaluating claims |
| `WithdrawPaymentAuthorization` | `/ixo.claims.v1beta1.MsgWithdrawPayment` | Authorization for withdrawing payments |
| `CreateClaimAuthorization` | `/ixo.claims.v1beta1.MsgCreateClaimAuthorization` | Authorization for creating claims |
...
- [IXO Payment Module Documentation](/guides/dev/payments)
