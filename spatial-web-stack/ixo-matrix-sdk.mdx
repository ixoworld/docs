---
title: 'IXO Matrix Client SDK'
description: 'Build secure data rooms and messaging systems for the Spatial Web using Matrix protocol integration'
---
<Note>
The IXO Matrix Client SDK provides encrypted data storage, secure messaging, and automated room management through Matrix protocol integration.
</Note>
...
<Card title="API Client" icon="server">
  Core Matrix API interactions
</Card>
