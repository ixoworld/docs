...
The IXO SDKs are designed with a modular architecture that allows developers to use them independently or in combination, depending on their application requirements.

<Frame>
  <img src="/docs/images/sdk-architecture.png" alt="IXO SDK Architecture" />
</Frame>
