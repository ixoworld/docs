...
description: 'Build secure data rooms and messaging systems with IXO Matrix protocol integration.'
---

<Tip>
  The IXO Matrix Client SDK provides encrypted data storage, secure messaging, and automated room management through IXO Matrix protocol integration.
</Tip>

## Overview

The IXO Matrix Client SDK is a toolkit for interacting with IXO Matrix servers and associated bot services. It provides capabilities for:
