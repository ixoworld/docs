...
description: "Build advanced IXO client applications with interchain networks, IXO Matrix integration, and Agentic Oracles."
---

<Tip>
  The IXO MultiClient SDK provides a unified interface for building IXO client applications that leverage interchain networks, IXO Matrix data storage, and Agentic Oracles.
</Tip>
...
<Tip>
  IXO SignX provides secure authentication and key management for IXO applications.
</Tip>
...
<CardGroup>
  <Card title="Components Guide" icon="cubes">
    Learn about IXO architecture components
  </Card>
