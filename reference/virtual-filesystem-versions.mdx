...
description: "List, read, and restore prior versions of a VFS file, resolve old CIDs after edits, and handle the 50-version cap and concurrent-write 409 responses."
