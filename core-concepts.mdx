...
description: 'Learn the fundamental concepts of the IXO Stack'
---

<Tip>
  IXO is a decentralized platform that enables you to create and manage cognitive digital twins of real-world systems, powered by blockchain networks, secure data storage, and Agentic Oracles.
</Tip>

<Note>
**Key Terminology**
- A **Digital Entity** is the foundational representation of any real-world actor or system in IXO.
