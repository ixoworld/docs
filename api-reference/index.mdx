...
icon: code
description: Comprehensive documentation for IXO API ecosystem
---

<Tip>
IXO API is comprehensive and spans multiple layers of the software stack, providing various functions to interact with different components of the IXO ecosystem.
</Tip>
...
The IXO API is organized around REST principles:
...
<Tip type="info">
### Test Mode
You can use The IXO API in test mode by directing server endpoints to our testnet blockchain.  
