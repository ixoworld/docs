...
<Tip>
The gRPC Gateway API provides a RESTful interface to access IXO blockchain's gRPC services, bridging the gap between high-performance gRPC and web-friendly REST APIs.
</Tip>
