...
<CardGroup>
  <Card title="Read developer guides" icon="code" href="/guides/dev/overview">
    Follow task-oriented implementation workflows.
  </Card>
  <Card title="Read core concepts" icon="lightbulb" href="/core-concepts">
    Understand architecture vocabulary and component relationships.
  </Card>
  <Card title="Open API reference" icon="book" href="/api-docs/introduction">
    Use canonical API pages for interface-level details.
  </Card>
  <Card title="Join developer community" icon="people-group" href="https://ixofoundation.slack.com">
    Ask implementation questions and share integration feedback.
  </Card>
</CardGroup>
