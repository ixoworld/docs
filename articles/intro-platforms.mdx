...
<CardGroup>
  ...
  <Card title="Architecture Guide" icon="layer-group" href="/spatial-web-stack/core-concepts">
    Detailed platform stack
  </Card>
  <Card title="Integration Guide" icon="puzzle-piece" href="/guides/dev/introduction">
