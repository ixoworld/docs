...
<CardGroup>
  <Card title="Agentic Oracles SDK" icon="code" href="/ixo-stack/sdks/oracle-agent-sdk">
...
<CardGroup>
  ...
  <Card title="SDK reference" icon="wand-magic-sparkles" href="/ixo-stack/sdks/oracle-agent-sdk">
