...
<AccordionGroup>
  ...
  <Accordion title="Agentic Oracles" icon="chart-line">
...
<CardGroup>
  <Card title="Agentic Oracles SDK" icon="code" href="/spatial-web-stack/sdks/oracle-agent-sdk">
    Canonical SDK page for building oracle-powered services.
  </Card>
...
<CardGroup>
  ...
  <Card title="SDK reference" icon="wand-magic-sparkles" href="/spatial-web-stack/sdks/oracle-agent-sdk">
    Use package-level details for implementation.
  </Card>

  <Card title="API reference" icon="plug" href="/api-docs/introduction">
