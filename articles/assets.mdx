...
Assets are digital representations of tangible or intangible resources that hold measurable value in IXO systems. Each asset is uniquely identified using decentralized identity standards and can be represented as a cognitive digital twin.
...
Each asset in IXO is implemented with:
...
Assets can be organized into collections, which are represented as digital entities in IXO. Collections enable:
...
Assets and their collections interact with the broader IXO architecture through:
...
<CardGroup cols={2}>
  <Card title="Entity domains" icon="diagram-project" href="/guides/dev/ixo-domains">
    Follow implementation workflows for domains and related assets.
  </Card>
  <Card title="API reference" icon="server" href="/api-reference/index">
    Use canonical API surfaces for gateways and application services.
  </Card>
</CardGroup>
