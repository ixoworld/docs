...
title: 'IXO PODs'
icon: 'code-simple'
description: 'Programmable Organisational Domains (PODs).'
---
...
<CardGroup>
  <Card title="IXO architecture stack" icon="layer-group">
    Foundational layers combining identity, data, AI, and blockchain components
  </Card>
  
  <Card title="Agentic Oracles" icon="crystal-ball">
...
### The IXO architecture stack

PODs are enabled by the IXO architecture stack, which combines **identity, data, AI, and blockchain** components into one coherent system:
...
<AccordionGroup>
  ...
  <Accordion title="Blockchain and Smart Contracts">
    The IXO architecture stack connects each domain to blockchain networks via the IXO MultiClient SDK. This provides the transactional and contractual backbone for POD operations.
  </Accordion>
</AccordionGroup>
...
- The Protocol Domains provide the blueprint, and the IXO architecture stack provides the execution engine
...
- IXO architecture helps communities coordinate watershed and resource-management systems
...
<CardGroup cols={2}>
  <Card title="Developer guides" icon="hand-pointer" href="/guides/dev/overview">
    Follow implementation workflows that relate to POD-style orchestration.
  </Card>
  <Card title="IXO Stack SDKs" icon="code" href="/sdk-reference/index">
    Choose SDK packages and integration paths for your build.
  </Card>
  <Card title="API reference" icon="server" href="/api-reference/index">
    Use interface-level references for gateways and application APIs.
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Challenges">
    - **Governance and Control:** Ensuring AI alignment with Organisational values
