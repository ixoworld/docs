...
- Use `/guides/dev/overview` for implementation workflows.
- Use `/spatial-web-stack/sdks/intro-sdks` for canonical SDK paths.
- Use `/api-docs/introduction` for interface-level references.
