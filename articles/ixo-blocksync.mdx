...
<CardGroup>
  <Card title="API Reference" icon="book" href="/api-docs/blocksync-api/schema">
    Complete schema documentation
  </Card>
  
  <Card title="GraphQL Playground" icon="browser" href="https://blocksync.ixo.earth/graphiql">
    Interactive query testing
  </Card>
  
  <Card title="GitHub" icon="github" href="https://github.com/ixofoundation/ixo-blocksync">
