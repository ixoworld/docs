...
description: "Conceptual overview of IXO Blocksync as the indexed query layer for IXO Protocol data."
---
...
<CardGroup>
  <Card title="Indexes protocol events" icon="bolt">
  ...
  <Card title="Supports auditability" icon="clock">
...
<AccordionGroup>
  ...
  <Accordion title="Data model perspective" icon="database">
...
<CardGroup>
  ...
  <Card title="IXO Protocol concepts" icon="book" href="/articles/ixo-protocol">
